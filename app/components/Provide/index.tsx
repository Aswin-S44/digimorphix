...
const Aboutdata: datatype[] = [
  ...
  {
    imgSrc: getImagePath("/assets/provide/marketing.svg"),
    country: "SEO Optimisation",
    paragraph: "Follow a hashtag total posts, videos",
  },
  {
    imgSrc: getImagePath("/assets/provide/marketing.svg"),
    country: "Social Media Management",
    paragraph: "Follow a hashtag total posts, videos",
  },
];
          ...
          <div className="col-span-6 flex justify-center">
            <div className="flex flex-col align-middle justify-center p-10">
              ...
              <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-bluegray">
                ...
                your business needs, covering everything from initial planning
                and user-focused design to robust development, testing, and
                smooth deployment.
              </h4>
              {/* <Link
                href={"/"}
